...
const PlayListCard = () => {
    ...
    //const marginProcessor = props.marginNone;
    //console.log(marginProcessor);
    return (
        <div class="PlayListCard">
            <CardContent>
                {/* <CardContent a={marginProcessor}> */}
                <ImgBox>
                ...
                <TextContent>
                    ...
                    <TitleArea>
                        <TitleLink href="/meditation-playlists/khiMbkvXGuXQVtMTJjCq">
                            <Title>COVID-19: Your Toolkit</Title>
                        </TitleLink>
                        <AvatarImgLink href="/insighttimer">
                            <TitleDes>Insight Timer</TitleDes>
                        </AvatarImgLink>
                    </TitleArea>
                </TextContent>
                <DescriptionArea>
                    <Description>
                        Essential music and meditation to get your
                        <a href="/hashtag/mind">#mind</a> off
                        <a href="/hashtag/covid19">#covid19</a> and back into the
                        <a href="/hashtag/presentmoment">#presentmoment</a>. Relieve your
                        <a href="/hashtag/coronavirusanxiety">#coronavirusanxiety</a>, find
                    </Description>
                </DescriptionArea>
            </CardContent>
        </div >
...
position: absolute;
box-sizing: inherit;
background: url("https://playlists.insighttimer.com/khiMbkvXGuXQVtMTJjCq%2Fpictures%2Fmontage_medium.jpeg?alt=media");
flex: 3;
